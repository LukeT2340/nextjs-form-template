...
> How-to guides are **directions** that guide the reader through a problem or towards a result. How-to guides are
> **goal-oriented**.
...
>
> Examples could be: *how to calibrate the radar array; how to use fixtures in pytest; how to configure reconnection
> back-off policies*. On the other hand, *how to build a web application* is not - that’s not addressing a specific goal
...
>
> Well-written how-to guides that address the right questions are likely to be the most-read sections of your
> documentation.
